<div class="container-fluid">
    <div class="card overflow-hidden chat-application" style="height: 100vh; height: 100%">
        <div class="d-flex align-items-center justify-content-between gap-3 m-3 d-lg-none">
            <button class="btn btn-outline-primary d-flex" type="button" data-bs-toggle="offcanvas" data-bs-target="#chat-sidebar" aria-controls="chat-sidebar">
                <i class="ti ti-arrow-back fs-5"></i>
            </button>
                                ...
                                <div class="px-9 py-6 border-top chat-send-message-footer">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <ul class="list-unstyledn mb-0 d-flex align-items-center">
                                            ...
                                            <li><a class="text-dark px-2 fs-7 bg-hover-primary nav-icon-hover position-relative z-index-5 active" href="javascript:void(0)"><i class="ti ti-send"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="offcanvas-body p-9">
                                    ...
                                    <div class="files-chat">
                                        ...
                                        <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-1 bg-light p-6">
                                                    <img src="http://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-adobe.svg" alt="" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-1 bg-light p-6">
                                                    <img src="http://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-figma.svg" alt="" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-1 bg-light p-6">
                                                    <img src="http://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-chrome.svg" alt="" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-1 bg-light p-6">
                                                    <img src="http://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-zip-folder.svg" alt="" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-1 bg-light p-6">
                                                    <img src="http://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-javascript.svg" alt="" width="24" height="24">
                                                </div>
                                                <div>
