    ...
    <div class="col-md-12">
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0">compound_profits List</h4>
            </div>
            <div class="card-body">
                <table class="table border text-nowrap customize-table mb-0 align-middle">
                    <thead>
                        ...
                        <?php foreach ($compound_profitss as $row) { ?>
                            <tr>
                                <td>
                                    <b><?=  ucfirst($row['type']); ?></b>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="index?p=compound_profits&action=edit&id=<?= $row['ID'] ?>"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                            </li>
                                            <!-- <li>
                                                <form action="" id="foo">
